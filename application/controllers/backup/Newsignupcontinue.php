        ...
        if(!empty($f_name) && !empty($l_name) && !empty($email) && !empty($pass) && !empty($re_pass)){
            ...
            if($userCount){
                ...
                if($insert){
                    ...
                    $linkk = SURL."Verify/index/$url";
                    $html = "<p>Dear Customer,</p>
                        <p>Thanks for registring,Greater freelancing platform.Please use the following Link to <a href='$linkk'>Verify Your account</a></p>
                        
                        <p style='width:200px; height:auto;'>[LOGO]</p>
                        <p>Kind Regards</p>
                        <p>Gigeconome Support Team</p>";
