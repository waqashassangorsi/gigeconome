...
<div class="container-fluid" style="background-color:white">
   ...
   <div class="container-fluid" id="heading">
       ...
       <div class="row" id="form_heading">
        ...
        <form method="post" action="Disputespage/insertdispute" enctype="multipart/form-data">
          ...
          <div class="form-group form_margin">
             <label for="user_type"  class="text_color">What type of user are you?</label>
              <select class="form-control  text_box  box_shadow" name="user_type" id="sel1">
                 ...
                 <option <?php echo $selectedfree;?>  class="text_color" value="Freelancer">I am a freelancer</option>
                 <option <?php echo $selectedbuy;?> class="text_color" value="Buyer">I am a buyer</option>
             </select>
         ...
         <div class="form-group form_margin">
             ...
             <input type="text" class="form-control text_box box_shadow"  value="" placeholder="Enter subject" id="email" name="subject">
