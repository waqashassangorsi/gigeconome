        ...
        <div class="row proposa_back">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12">
                <div class="button_action" id="wrpr_pro_section_<?php echo $value['msg_id'];?>">
                    ...
                    ?>
                                <button type="button" class="btn btn_inovce cancelrefund" <?php echo $disabled_action;?> data-value="<?php echo $value['msg_id']; ?>">Cancel</button>
                            <?php }else{?>
                            <div>
                                <button type="button" class="btn btn_inovce acceptrefund" <?php echo $disabled_action;?> style="background:#007d3d;color:white;" data-value="<?php echo $value['msg_id']; ?>">Accept</button>
                                <button type="button" class="btn btn_inovce reject_refund btn-danger" <?php echo $disabled_action;?> data-value="<?php echo $value['msg_id']; ?>">Reject</button>
                            </div>
                            <?php } ?>
...
<div class="reject_wpar">
    <div class="row">
        ...
        <div class="col-sm-10" style="border-left: 3px solid #cc2424;margin-left: 12px;">
            <div class="accept_cont">
                <h4>Your Refund request has been rejected, send another or raise a dispute by <a class="dispute_link" data-href="Disputespage/index/<?php echo $value['job_id'].'/'.$value['msg_id'];?>" href="<?php echo SURL.'Disputespage/index/'.$value['job_id'].'/'.$value['msg_id'];?>">clicking me</a>.</h4>
            </div>
        </div>
    </div>
</div>
