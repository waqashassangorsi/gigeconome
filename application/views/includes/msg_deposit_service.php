        ...
        <div class="row">
            <div class="col-xs-12 propmain_heading">
                <p>
                    <b>
                    <?php 
                        echo $this->Common->gettimeinmyzone($value['date']);
                    ?>
                </b></p>
        ...
        <div class="row proposa_back">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12">
                <div class="button_action" id="wrpr_pro_section_<?php echo $value['msg_id'];?>">
                    ...
                    ?>
                                <button type="button" class="btn btn_inovce canceldepositservice" data-value="<?php echo $value['msg_id']; ?>">Cancel</button>
                            <?php }else{?>
                            <div>
                                <button type="button" class="btn btn_inovce acceptdeposit_refund" style="background:#007d3d;color:white;" data-value="<?php echo $value['msg_id']; ?>">Accept</button>
                                <button type="button" class="btn btn_inovce reject_depositservice btn-danger" data-value="<?php echo $value['msg_id']; ?>">Reject</button>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10" style="border-left: 3px solid #007d3d;margin-left: 12px;">
            <div class="accept_cont">
                ...
                <h4><?php echo ucwords($buyername['f_name']." ".$buyername['l_name']);?> has deposited £<?php echo number_format($value['deposit_amt'],2); ?> in your Escrow Account so you can get cracking.</h4>
            </div>
        </div>
    </div>
</div>
